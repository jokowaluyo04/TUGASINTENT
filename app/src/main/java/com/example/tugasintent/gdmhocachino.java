...
public class gdmhocachino extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gdmhocachino);

        // Referensi ke ImageView dan TextView di layout XML
        imageView = findViewById(R.id.gdd4);
        textView = findViewById(R.id.tvn12);

        // Menetapkan gambar ke ImageView
        imageView.setImageResource(R.drawable.ic_gdmhocachino);
