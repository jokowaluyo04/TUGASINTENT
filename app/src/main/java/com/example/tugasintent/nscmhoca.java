...
public class nscmhoca extends AppCompatActivity {
    ImageView imageView;
    TextView textView;
    Button btnShare;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nscmhoca);

        // Referensi ke ImageView dan TextView di layout XML
        imageView = findViewById(R.id.nsff4);
        textView = findViewById(R.id.tvn12);

        // Menetapkan gambar ke ImageView
        imageView.setImageResource(R.drawable.ic_nscmocha);
